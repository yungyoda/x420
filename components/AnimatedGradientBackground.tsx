...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
   ...
   Breathing = false,
   gradientColors = [
      "#0b0f13", // base background
      "#0f141a", // elevated background
      "#0b0f13", // return to base
      "#22d3ee", // accent strong
      "#6ee7ff", // accent
      "#0f141a", // elevated fade
      "#0b0f13"  // base fade out
   ],
   ...
   return (
      <motion.div
         ...
         aria-hidden="true"
         className={`fixed inset-0 overflow-hidden pointer-events-none z-0 ${containerClassName}`}
      >
         <div
            ref={containerRef}
